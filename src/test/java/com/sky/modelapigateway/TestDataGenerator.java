...
import com.sky.modelapigateway.enums.ProjectStatus;
...
public class TestDataGenerator {
    ...
    @Autowired
    private ApikeyMapper apiKeyRepository;

    @Autowired
    private ApiInstanceMapper apiInstanceRepository;

    @Autowired
    private SelectionService selectionAppService;
