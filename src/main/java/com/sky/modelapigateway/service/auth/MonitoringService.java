package com.sky.modelapigateway.service.auth;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.sky.modelapigateway.assembler.MonitoringAssembler;
...
import com.sky.modelapigateway.domain.observe.TimePointDTO;
...
import com.sky.modelapigateway.mapper.ApiInstanceMetricsMapper;
...
public class MonitoringService {
    ...
    private final ApiInstanceMapper ApiInstanceMapper;
    private final ApiInstanceMetricsMapper apiInstanceMetricsMapper;
    private final ProjectMapper projectMapper;
    public MonitoringService(ApiInstanceMapper ApiInstanceMapper,
                             ApiInstanceMetricsMapper apiInstanceMetricsMapper,
                             ProjectMapper projectMapper) {
        this.ApiInstanceMapper = ApiInstanceMapper;
        this.apiInstanceMetricsMapper = apiInstanceMetricsMapper;
    ...
    public MonitoringOverviewDTO getMonitoringOverview(String projectId) {
        ...
        if (projectId != null && !projectId.isEmpty()) {
            ...
            instances = ApiInstanceMapper.selectList(wrapper);
        } else {
            instances = ApiInstanceMapper.selectList(null);
        }
        ...
        List<ApiInstanceMetricsEntity> recentMetrics = apiInstanceMetricsMapper.selectList(metricsWrapper);
    ...
    private Map<String, ApiInstanceMetricsEntity> getLatestMetricsMap(List<String> instanceIds) {
        ...
        for (String instanceId : instanceIds) {
            ...
            wrapper.eq(ApiInstanceMetricsEntity::getRegistryId, instanceId)
                    ...
                    .last("LIMIT 1");
            List<ApiInstanceMetricsEntity> metrics = apiInstanceMetricsMapper.selectList(wrapper);
    ...
    public TimeSeriesDTO getTimeSeriesData(String timeRange, String projectId) {
        ...
        if (projectId != null && !projectId.isEmpty()) {
            ...
            List<ApiInstanceEntity> instances = ApiInstanceMapper.selectList(instanceWrapper);
