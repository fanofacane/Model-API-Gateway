...
import com.sky.modelapigateway.service.project.Impl.ProjectServiceImpl;
...
public class AuthenticationAppService {
    ...
    private final ProjectServiceImpl projectDomainService;

    public AuthenticationAppService(ApiKeyDomainService apiKeyDomainService,
                                    ProjectServiceImpl projectDomainService) {
