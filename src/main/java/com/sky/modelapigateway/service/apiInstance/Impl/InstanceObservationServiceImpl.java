...
@Service
public class InstanceObservationServiceImpl implements InstanceObservationService {

    private static final Logger logger = LoggerFactory.getLogger(InstanceObservationServiceImpl.class);

    private final ApiInstanceMapper apiInstanceMapper;

    private final ApiInstanceMetricsMapper metricsMapper;
    private final ProjectMapper projectMapper;

    public InstanceObservationServiceImpl(ApiInstanceMapper apiInstanceMapper,
                                          ApiInstanceMetricsMapper metricsMapper,
    ...
    private List<ApiInstanceEntity> getFilteredInstances(InstanceObservationRequest request) {
        ...
        List<ApiInstanceEntity> instances = apiInstanceMapper.selectList(wrapper);
    ...
    private Map<String, ApiInstanceMetricsEntity> getAggregatedMetrics(List<ApiInstanceEntity> instances, LocalDateTime startTime) {
        ...
        List<ApiInstanceMetricsEntity> allMetrics = metricsMapper.selectList(wrapper);
        ...
        if (!allMetrics.isEmpty()) {
            ...
            List<ApiInstanceMetricsEntity> allMetricsForDiag = metricsMapper.selectList(null);
